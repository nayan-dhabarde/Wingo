...
class TournamentPagingSource(
    ...
    private val currentMonthDateServerFormatted: String,
    private val currentMonthDatePlusNextYearServerFormatted: String
    ...
    override suspend fun load(params: LoadParams<Int>): LoadResult<Int, Tournament> {
        return try {
            ...
            val response = apiService.getTournaments(nextPageNumber, pageSize,
            "$currentMonthDateServerFormatted,$currentMonthDatePlusNextYearServerFormatted").await()
